...
# allauth
SITE_ID = 1
ACCOUNT_EMAIL_VERIFICATION = "mandatory"  #  'none' / "optionnal"
...
# email configuration set in dev/pre/prod

# to change email template
# https://django-rest-auth.readthedocs.io/en/latest/configuration.html
# REST_AUTH_SERIALIZERS = {
#     'PASSWORD_RESET_SERIALIZER': 'path.to.custom.LoginSerializer',
#     'PASSWORD_RESET_CONFIRM_SERIALIZER ': 'path.to.custom.TokenSerializer',
